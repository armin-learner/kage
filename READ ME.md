...
=======
KAGE
KAGE est un jeu de plateforme narratif en 2D développé en JavaScript avec la librairie Kaplay.js.
...
- **Niveau 1 – La Chauve-souris (Caverne)**
  Voler à travers une caverne souterraine, utilsier l'echolocalisation (E) pour esquiver stalactites, stalagmites et éboulements.
- **Niveau 2 – Le Scarabée (Forêt)**
  Charger pour briser des obstacles, saut/planneur.
- **Niveau 3 – La Grenouille (Étang)**
  Charger ses sauts et traverser des environnements instables.
...
- un écran de fin affichant les statistiques de jeu (temps, gemmes, progression).

---
=======
Le joueur incarne KAGE, une créature recluse ayant vécu toute son existence dans une grotte souterraine. À la suite d'une catastrophe naturelle (tremblements de terre et inondation), son terrier est détruit. Contraint de quitter son refuge, KAGE part explorer un monde inconnu à la recherche d'un nouvel endroit où s'installer.

Le jeu repose sur une progression linéaire en trois niveaux, chacun introduisant une nouvelle capacité qui permet au joueur de s'adapter à son environnement :
    Niveau 1 – La Chauve-souris (Caverne) Voler à travers une caverne souterraine, esquiver stalactites, stalagmites et éboulements.
    Niveau 2 – Le Scarabée (Forêt) Charger pour briser des obstacles, résoudre des puzzles physiques.
    Niveau 3 – La Grenouille (Étang) Charger ses sauts et traverser des environnements instables.
...
Le jeu est encadré par :
    ...
    une cinématique de fin concluant le voyage de KAGE,
    un écran de fin affichant les statistiques de jeu (temps, gemmes, progression).
>>>>>>> af471df94b23f9f14d97a4a7407106db1f8de741

## 2. Captures du projet

![alt text](https://github.com/Armin-learner/KAGE/blob/main/Capture%20d%E2%80%99%C3%A9cran%202026-04-24%20%C3%A0%2017.53.48.png)
![alt text](https://raw.githubusercontent.com/Armin-learner/KAGE/refs/heads/main/Capture%20d%E2%80%99%C3%A9cran%202026-05-13%20%C3%A0%2009.51.11.png)
![alt text](https://raw.githubusercontent.com/Armin-learner/KAGE/refs/heads/main/Capture%20d%E2%80%99%C3%A9cran%202026-05-13%20%C3%A0%2009.50.51.png)
![alt text](https://raw.githubusercontent.com/Armin-learner/KAGE/refs/heads/main/Capture%20d%E2%80%99%C3%A9cran%202026-05-13%20%C3%A0%2009.51.22.png)
---
...
4. Lancer un serveur local (par exemple via Live Server).
=======
...
Lancement
    ...
    Ouvrir le dossier racine du projet dans Visual Studio Code.
    S'assurer que le fichier index.html se trouve à la racine.
    Lancer un serveur local (par exemple via Live Server).
...
- **Kaplay.js**
  Librairie JavaScript pour le développement de jeux 2D (gestion des scènes, collisions, caméra, inputs, UI).
- **JavaScript (ES modules)**
  Langage principal du projet.
- **HTML5 / Canvas**
  Support d'affichage du jeu.
...
Le projet utilise et adapte le pack graphique :

> **Swamp Kingdom – Platformer Tileset**
> Créé par the14collective
> Disponible sur itch.io :
> https://14collective.itch.io/swamp-kingdom-platfomer-tileset

Les assets sont utilisés conformément à la licence du pack :
- usage autorisé dans des projets gratuits et commerciaux,
- modification autorisée,
- revente ou redistribution des assets seuls interdite.

Les assets ont été réorganisés, découpés et intégrés pour correspondre aux besoins visuels et ludiques du projet.
...
Pour résoudre le problème de performance, le niveau a été redessiné en **défilement horizontal** avec seulement ~80 blocs de terre. Le joueur avançait de gauche à droite en creusant des murs de terre, avec des piliers de pierre forçant des détours.
...
### Modèle utilisé
- Copilot (Microsoft) et Claude (Anthropic)
...
=======
    Kaplay.js Librairie JavaScript pour le développement de jeux 2D (gestion des scènes, collisions, caméra, inputs, UI).
...
Le projet utilise et adapte les packs graphiques :
    Swamp Kingdom – Platformer Tileset Créé par the14collective Disponible sur itch.io : https://14collective.itch.io/swamp-kingdom-platfomer-tileset Profil itch.io : https://14collective.itch.io/ 
    Bosses - Frogger - Créer par Admurin sur itch.io :https://admurin.itch.io/bosses-frogger Profil itch.io : https://admurin.itch.io/ 
